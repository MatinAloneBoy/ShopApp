...
public class Change_PhoneNumber_Page extends Fragment {
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        sendPhoneButton=view.findViewById(R.id.ChangePhoneNumber_button);
        newPhoneText=view.findViewById(R.id.new_PhoneNumber_to_change_text);
        newPhoneBox=view.findViewById(R.id.new_phoneNumber_to_change_edit_text);
        String mail;
